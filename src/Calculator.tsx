...
export default function Calculator() {
  ...
  // Modifiera här så att symbol är en specifik nyckel i Operators
  function calculate(
    buffer: number,
    currentTotal: number,
    symbol: keyof Operators // Nyckeln i Operators
  ): number {
      ...
      case "+/-":
        ...
        }
        {
          const changedValue: number = calculate(
            parseFloat(input),
            total,
            symbol as keyof Operators // Typassertion här för att säga att symbol är en giltig nyckel
          );
      ...
      case "=":
        ...
        if (input === null || prevSymbol === null) return;
        {
          const finalTotal: number = calculate(
            parseFloat(input),
            total,
            prevSymbol as keyof Operators // Typassertion här också
          );
